...
forColuna2: #percorre as linhas, copiando colunas de pixels de uma regiÃ£o de memÃ³ria para outra.

	beq $11, $10, retornoRest2 # Se $11 (contador de linhas) alcanÃ§ar $10, sai do loop
	
	add $14, $0, $8 # Guarda o endereÃ§o inicial de $8 em $14
	add $15, $0, $9 # Guarda o endereÃ§o inicial de $9 em $15
	forLinha2:  #percorre os pixels em cada linha, copiando-os de um endereÃ§o para outro.
	beq $12, $13, prxColuna2  # Se $13 (contador de pixels) alcanÃ§ar $12, vai para a prÃ³xima coluna
...
prxColuna2: #Ajusta os endereÃ§os para a prÃ³xima linha e reseta o contador de pixels
	...
	j forColuna2
retornoRest2: #Essas instruÃ§Ãµes restauram os registradores da pilha e retornam ao endereÃ§o salvo em $31.
	add $sp, $sp, 4
	lw $21, 0($sp)
