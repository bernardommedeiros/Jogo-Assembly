...
sw $16, -4060($8)  # -3548 - 512 = -4060
#4 linha - alterado
sw $16, -4616($8)  # -4096 - 512 = -4608
sw $16, -4612($8)  # -4096 - 512 = -4608
sw $16, -4608($8)  # -4096 - 512 = -4608
sw $16, -4604($8)  # -4092 - 512 = -4604
sw $16, -4600($8)  # -4088 - 512 = -4600
sw $17, -4596($8)  # -4084 - 512 = -4596
sw $17, -4592($8)  # -4080 - 512 = -4592
sw $17, -4588($8)  # -4076 - 512 = -4588
sw $17, -4584($8)  # -4072 - 512 = -4584
sw $16, -4580($8)  # -4068 - 512 = -4580
sw $16, -4576($8)  # -4064 - 512 = -4576
sw $16, -4572($8)  # -4060 - 512 = -4572
sw $16, -4568($8)  # -4060 - 512 = -4572
sw $16, -4564($8)  # -4060 - 512 = -4572
...
#11 linha
sw $16, -8184($8)  # -7672 - 512 = -8184
sw $16, -8180($8)  # -7668 - 512 = -8180
sw $16, -8176($8)  # -7664 - 512 = -8176
sw $16, -8172($8)  # -7660 - 512 = -8172
sw $16, -8168($8)  # -7656 - 512 = -8168
sw $16, -8164($8)  # -7652 - 512 = -8164
